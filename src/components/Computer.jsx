...
export function Computer(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/smol.glb')
  ...
  useFrame(() => {
    if (group.current) {
      group.current.rotation.y = mousePosition.x * Math.PI * 0.1 // Adjust the sensitivity as needed
      group.current.rotation.x = mousePosition.y * Math.PI * 0.1 // Adjust the sensitivity as needed
    }
  })
...
useGLTF.preload('/models/smol.glb')
